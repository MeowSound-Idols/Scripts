...
# From: https://www.mobileread.com/forums/showpost.php?p=3114050&postcount=1145
import sys
...
def processCRES(i, data):
    ...
    imgdir = os.path.join(sys.argv[2], "azw6_images")
...
def usage(progname):
    ...
    print("  ")
    print("Usage:")
    print("  %s <input_path> <output_path>" % progname)
    print("  ")
    print("Options:")
...
def main(argv=sys.argv):
    ...
    try:
        ...
        dtmap = {
            ...
            b"CRES": b"CRES",
            b"CONT": b"CONT",
            b"\xa0\xa0\xa0\xa0": b"Empty_Image/Resource_Placeholder",
            b"\xe9\x8e\r\n" : b"EOF_RECORD",
            }
        dtmap2 = {
